...
public class QCloverLog extends EntityPathBase<CloverLog> {
    ...
    public final EnumPath<com.example.cluvrapi.domain.clover.enums.CloverActionType> actionType = createEnum("actionType", com.example.cluvrapi.domain.clover.enums.CloverActionType.class);
