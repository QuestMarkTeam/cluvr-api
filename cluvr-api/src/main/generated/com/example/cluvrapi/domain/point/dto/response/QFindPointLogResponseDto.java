...
/**
 * com.example.cluvrapi.domain.point.dto.response.QFindPointLogResponseDto is a Querydsl Projection type for FindGemLogResponseDto
 */
...
public class QFindPointLogResponseDto extends ConstructorExpression<FindPointLogResponseDto> {
	...
	public QFindPointLogResponseDto(com.querydsl.core.types.Expression<Long> userId,
		...
		super(FindPointLogResponseDto.class,
