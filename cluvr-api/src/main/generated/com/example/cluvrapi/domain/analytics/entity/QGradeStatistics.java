...
/**
 * QGradeStatistics is a Querydsl query type for GradeStatistics
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QGradeStatistics extends EntityPathBase<GradeStatistics> {

    private static final long serialVersionUID = 2014479766L;
    ...
    public QGradeStatistics(Class<? extends GradeStatistics> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new com.example.cluvrapi.domain.category.entity.QCategory(forProperty("category")) : null;
